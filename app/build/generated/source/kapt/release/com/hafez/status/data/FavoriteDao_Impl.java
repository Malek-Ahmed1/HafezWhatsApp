...
public final class FavoriteDao_Impl implements FavoriteDao {
  ...
  public FavoriteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFavoriteEntity = new EntityInsertionAdapter<FavoriteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `favorites` (`path`,`name`,`type`,`addedAt`) VALUES (?,?,?,?)";
      }
  ...
  @Override
  public Object insert(final FavoriteEntity item, final Continuation<? super Unit> $completion) {
  ...
  @Override
  public Object delete(final FavoriteEntity item, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __deletionAdapterOfFavoriteEntity.handle(item);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
      ...
      public List<FavoriteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new FavoriteEntity(_tmpPath,_tmpName,_tmpType,_tmpAddedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object isFavorite(final String path, final Continuation<? super Boolean> $completion) {
